...
set tech_file = $mypath/scripts/pt_tech_file_tt85.tcl
...
set signoff_views = ( \
func_nd_tt85_typical_85c_setup \
)
##########################prepare pt env############################################3
foreach i ( $signoff_views )
    ...
    sed -e "s/SETUPPATH\/setup_tt85.tcl/${aa}\/scripts\/setup_tt85.tcl/g" tmp > tmpa
